...
*문서 버전: v2.3 · P0~P3 완료 + **P4.0 정지작업 · P4.1 재고 원장 · P4.2 입고(GR) · P4.3 출고(Delivery) 완료·종결**(2026-07-16) — 발번·날짜 전면 KST화 / 마스터 감사 / `000_baseline.sql` 재구축 복원 / Vitest 도입(테스트 112) / `stock_movements` 추가전용 원장·권한 봉인·역분개(D1·D2·D3) / 입고 참조생성·`GR_IN` 전기·잔량 뷰·부분입고·상태 자동전환·세대 도장·잔량 소비 가드(C5) / **출고 참조생성·`DLV_OUT` 전기·SO 잔량 뷰·부분출고·마이너스 경고 후 허용·상태 자동전환·취소=역분개·거래명세서 인쇄(B8)** / **P4.3f uom 폴백 정정(라인 uom → products.unit → 거부, 'PCS' 발명 금지 — 입고·출고 일괄) + high 3건 재검증 + 스팟체크(오너 위임 대행) 통과 = P4.3 종결**. 원칙 5에 "잔량 소비 가드" 이행분 명기(발주↔입고 P4.2 · 수주↔출고 P4.3). 다음: P4.4 선적 라인·parties·S/I → P4.5 무역서류(CI/PL) → P4.6 문서 흐름 추적*
