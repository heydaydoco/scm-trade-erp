...
- A1. 품목 마스터 (HS코드, 단위, 표준단가, 원산지, 위험물여부, 시리얼/로트 관리여부) `[P1]`
- A2. BOM (자재명세서, 다단, 스크랩률, 유효일자=설계변경 컷인) `[P5]`
- A3. 거래처 마스터 (고객/공급사/both, 사업자번호, 결제조건, 통화, Incoterms, 신용한도) `[P1]`
...
- C3. 발주 (Purchase Order, 헤더-라인) `[P3]`
- C4. 발주 확인(Order Confirmation) 접수 `[P3]`
...
- I1. 대시보드 (수출실적, 국가별/품목별/거래처별 매출) `[P2~]`
