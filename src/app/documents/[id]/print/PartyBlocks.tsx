import { docContainerNoLabel } from "@/services/tradeDocuments";
...
export function ShipmentInfoGrid({ doc }: { doc: TradeDocument }) {
  // Container No.(P5.3 판정 ②·D9) — 적입 스냅샷 3상태를 단일 규칙으로(docContainerNoLabel):
  //   NULL(P5.3 이전 발행)→스칼라 폴백 / 빈 구조(적입 0건)→항목 생략 / 값→번호 조인(TBA)
